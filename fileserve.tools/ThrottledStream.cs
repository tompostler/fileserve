namespace Unlimitedinf.Fileserve.Tools
{
    ...
    public class ThrottledStream : Stream
    {
        ...
        public float MaximumKilobytesPerSecond
        {
            get
            {
                return MaximumBytesPerSecond / 1000f;
            }
            set
            {
                MaximumBytesPerSecond = (long)(value * 1000);
            }
        }
        ...
        public float MaximumMegabytesPerSecond
        {
            get
            {
                return MaximumKilobytesPerSecond / 1000f;
            }
            set
            {
                MaximumKilobytesPerSecond = (long)(value * 1000);
            }
        }
        ...
        /// <exception cref="System.NotSupportedException">The base stream does not support seeking. </exception>
        ...
        /// <exception cref="System.ObjectDisposedException">Methods were called after the stream was closed. </exception>
        /// <exception cref="System.NotSupportedException">The base stream does not support reading. </exception>
        ...
        /// </returns>
        /// <exception cref="System.IO.IOException">An I/O error occurs. </exception>
        /// <exception cref="System.NotSupportedException">The base stream does not support seeking, such as if the stream is constructed from a pipe or console output. </exception>
        /// <exception cref="System.ObjectDisposedException">Methods were called after the stream was closed. </exception>
        ...
        /// <exception cref="System.NotSupportedException">The base stream does not support both writing and seeking, such as if the stream is constructed from a pipe or console output. </exception>
        /// <exception cref="System.IO.IOException">An I/O error occurs. </exception>
        /// <exception cref="System.ObjectDisposedException">Methods were called after the stream was closed. </exception>
        ...
        /// <exception cref="System.IO.IOException">An I/O error occurs. </exception>
        /// <exception cref="System.NotSupportedException">The base stream does not support writing. </exception>
        /// <exception cref="System.ObjectDisposedException">Methods were called after the stream was closed. </exception>
        /// <exception cref="System.ArgumentNullException">buffer is null. </exception>
